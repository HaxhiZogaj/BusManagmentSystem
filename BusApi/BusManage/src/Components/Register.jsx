...
import background from '../assets/loginbusat.jpg';

const API_URL = "https://localhost:7255/api/users/register"; 
...
const styles = {
    pageWrapper: {
      ...
      card: {
        width: "600px",
        background: "rgba(219, 218, 207, 0.9)", // pak transparencë për efekt
        padding: "60px",
        borderRadius: "25px",
